...
public class GetSongInfoEvent extends Event {
    ...
    void init() {
        try {
            Method m = RequestManager.class.getMethod("getSongInfo", int.class);
    ...
    public GetSongInfoEvent(Object... parameterValues) throws NoSuchFieldException {
