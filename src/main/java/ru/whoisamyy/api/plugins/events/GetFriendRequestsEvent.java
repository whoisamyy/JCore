...
public class GetFriendRequestsEvent extends Event {
    ...
    static {
        try {
            Method m = RequestManager.Relationships.class.getMethod("getGJFriendRequests", int.class, Boolean.class, Integer.class, String.class, String.class);
    ...
    public GetFriendRequestsEvent(Object... parameterValues) throws NoSuchFieldException {
