...
public class DeleteLevelEvent extends Event {
    ...
    static {
        try {
            Method m = RequestManager.Levels.class.getMethod("deleteGJLevel", int.class, String.class, int.class, String.class);
    ...
    public DeleteLevelEvent(Object... parameterValues) throws NoSuchFieldException {
