...
public class LikeEvent extends Event {
    ...
    void init() {
        try {
            Method m = RequestManager.class.getMethod("like", String.class, int.class, int.class, boolean.class, Integer.class, String.class);
    ...
    public LikeEvent(Object... parameterValues) throws NoSuchFieldException {
