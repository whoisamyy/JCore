...
public class BlockUserEvent extends Event {
    ...
    void init() {
        try {
            Method m = RequestManager.Relationships.class.getMethod("blockGJUser", String.class, int.class, int.class, String.class);
    ...
    public BlockUserEvent(Object... parameterValues) throws NoSuchFieldException {
