...
public class AcceptFriendRequestEvent extends Event {
    ...
    static {
        try {
            Method m = RequestManager.Relationships.class.getMethod("acceptGJFriendRequest", int.class, int.class, String.class, String.class);
    ...
    public AcceptFriendRequestEvent(Object... parameterValues) throws NoSuchFieldException {
