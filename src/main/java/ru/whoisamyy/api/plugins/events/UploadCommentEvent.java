...
public class UploadCommentEvent extends Event {
    ...
    void init() {
        try {
            Method m = RequestManager.Comments.class.getMethod("uploadGJComment", int.class, String.class, String.class, int.class, Integer.class, String.class, String.class);
