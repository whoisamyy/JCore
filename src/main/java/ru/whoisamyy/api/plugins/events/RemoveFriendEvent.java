...
public class RemoveFriendEvent extends Event {
    ...
    void init() {
        try {
            Method m = RequestManager.Relationships.class.getMethod("removeGJFriend", int.class, int.class, String.class, String.class);
    ...
    public RemoveFriendEvent(Object... parameterValues) throws NoSuchFieldException {
