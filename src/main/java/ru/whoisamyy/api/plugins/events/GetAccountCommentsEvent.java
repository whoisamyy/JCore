...
public class GetAccountCommentsEvent extends Event {
    ...
    static {
        try {
            Method m = RequestManager.Comments.class.getMethod("getGJAccountComments", int.class, int.class, String.class);
    ...
    public GetAccountCommentsEvent(Object... parameterValues) throws NoSuchFieldException {
