...
public class DeleteFriendRequestEvent extends Event {
    ...
    void init() {
        try {
            Method m = RequestManager.Relationships.class.getMethod("deleteGJFriendRequest", int.class, int.class, String.class, String.class);
    ...
    public DeleteFriendRequestEvent(Object... parameterValues) throws NoSuchFieldException {
