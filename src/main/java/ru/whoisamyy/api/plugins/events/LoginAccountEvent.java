...
public class LoginAccountEvent extends Event {
    ...
    void init() {
        try {
            Method m = RequestManager.Accounts.class.getMethod("loginGJAccount", String.class, String.class, String.class, String.class);
    ...
    public LoginAccountEvent(Object... parameterValues) throws NoSuchFieldException {
