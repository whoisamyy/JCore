...
public class ReadFriendRequestEvent extends Event {
    ...
    void init() {
        try {
            Method m = RequestManager.Relationships.class.getMethod("readFriendRequest", int.class, int.class, String.class, String.class);
    ...
    public ReadFriendRequestEvent(Object... parameterValues) throws NoSuchFieldException {
