...
public class DownloadMessageEvent extends Event {
    ...
    void init() {
        try {
            Method m = RequestManager.Messages.class.getMethod("downloadGJMessage", String.class, int.class, int.class);
    ...
    public DownloadMessageEvent(Object... parameterValues) throws NoSuchFieldException {
