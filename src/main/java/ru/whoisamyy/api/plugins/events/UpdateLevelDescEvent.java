...
public class UpdateLevelDescEvent extends Event {
    ...
    void init() {
        try {
            Method m = RequestManager.Levels.class.getMethod("updateGJDesc", int.class, int.class, String.class, String.class, String.class);
    ...
    public UpdateLevelDescEvent(Object... parameterValues) throws NoSuchFieldException {
