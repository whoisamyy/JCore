...
public class BackupAccountEvent extends Event {
    ...
    static {
        try {
            Method m = RequestManager.Accounts.class.getMethod("backupGJAccountNew", String.class, String.class, String.class, String.class);
    ...
    public BackupAccountEvent(Object... parameterValues) throws NoSuchFieldException {
