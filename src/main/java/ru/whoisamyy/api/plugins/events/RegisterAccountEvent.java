...
public class RegisterAccountEvent extends Event {
    ...
    void init() {
        try {
            Method m = RequestManager.Accounts.class.getMethod("registerGJAccount", String.class, String.class, String.class, String.class);
    ...
    public RegisterAccountEvent(Object... parameterValues) throws NoSuchFieldException {
