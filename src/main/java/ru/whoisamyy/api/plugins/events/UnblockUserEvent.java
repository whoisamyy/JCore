...
public class UnblockUserEvent extends Event {
    ...
    void init() {
        try {
            Method m = RequestManager.Relationships.class.getMethod("unblockGJUser", String.class, int.class, int.class, String.class);
    ...
    public UnblockUserEvent(Object... parameterValues) throws NoSuchFieldException {
