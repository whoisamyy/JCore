...
public class GetUserListEvent extends Event {
    ...
    void init() {
        try {
            Method m = RequestManager.Relationships.class.getMethod("getGJUserList", String.class, int.class, Boolean.class, String.class);
    ...
    public GetUserListEvent(Object... parameterValues) throws NoSuchFieldException {
