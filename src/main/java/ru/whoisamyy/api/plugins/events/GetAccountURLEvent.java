...
public class GetAccountURLEvent extends Event {
    ...
    static {
        try {
            Method m = RequestManager.Accounts.class.getMethod("getAccUrl");
    ...
    public GetAccountURLEvent(Object... parameterValues) throws NoSuchFieldException {
