...
public class UploadMessageEvent extends Event {
    ...
    static {
        try {
            Method m = RequestManager.Messages.class.getMethod("uploadGJMessage", String.class, int.class, int.class, String.class, String.class);
    ...
    public UploadMessageEvent(Object... parameterValues) throws NoSuchFieldException {
