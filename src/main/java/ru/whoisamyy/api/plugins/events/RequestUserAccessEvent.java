...
public class RequestUserAccessEvent extends Event {
    ...
    void init() {
        try {
            Method m = RequestManager.class.getMethod("requestUserAccess", String.class, int.class, String.class);
    ...
    public RequestUserAccessEvent(Object... parameterValues) throws NoSuchFieldException {
